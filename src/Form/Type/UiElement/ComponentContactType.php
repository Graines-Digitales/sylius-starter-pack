...
class ComponentContactType extends AbstractType
{
    ...
    {
        $code = 'component_contact'; // Use the code defined on the component creation in admin pannel
        ...
        $builder
            ...
            ->add('address', TextType::class, [
                'required' => false,
                'label' => 'app.ui_element.field.address',
            ])
            ->add('phone', TextType::class, [
                'required' => false,
                'label' => 'app.ui_element.field.phone',
            ])
            ->add('email', TextType::class, [
                'required' => false,
                'label' => 'app.ui_element.field.email',
            ])
